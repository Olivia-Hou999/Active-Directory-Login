...
namespace ADHelper
{
    ...
    public sealed class ADHelper2     {
        ...
        private static string DomainName = "sucai.com";//要修改 codeby lanhai96
        ...
        private static string LDAPDomain = "DC=sucai,DC=com";//要修改 codeby lanhai96
        ...
        private static string ADPath = "LDAP://sucai.com";//要修改 codeby lanhai96
        ...
        private static string ADUser = "Administrator";//要修改 codeby lanhai96
        ...
        private static string ADPassword = "***lanhai96";//AD 服务器的密码，要修改成你的 codeby lanhai96
        ...
        public static DirectoryEntry CreateNewUser(string ldapDN, string commonName, string sAMAccountName, string password)         {
            ...
            //{
                ...
                ADHelper2.SetPassword(commonName, password);

                ADHelper2.EnableUser(commonName);//启用该用户
        ...
        public static void EnableUser(DirectoryEntry de)         {
            ...
            de.Properties["userAccountControl"][0] = ADHelper2.ADS_USER_FLAG_ENUM.ADS_UF_NORMAL_ACCOUNT | ADHelper2.ADS_USER_FLAG_ENUM.ADS_UF_DONT_EXPIRE_PASSWD;
        ...
        public static void DisableUser(DirectoryEntry de)         {
            ...
            de.Properties["userAccountControl"][0] = ADHelper2.ADS_USER_FLAG_ENUM.ADS_UF_NORMAL_ACCOUNT | ADHelper2.ADS_USER_FLAG_ENUM.ADS_UF_DONT_EXPIRE_PASSWD | ADHelper2.ADS_USER_FLAG_ENUM.ADS_UF_ACCOUNTDISABLE;
